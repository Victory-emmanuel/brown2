  ...
  return (
    <>
      <div id="about" className="">
        {/* HERO */}
        <section className=" relative img ">
          <img
          ...
          <div className="  ss:px-12 xx:px-6 grid  text-center ">
            ...
            <p className="sm:text-2xl xx:text-lg md:w-[50%] sm:w-[75%] xx:w-full mx-auto text-white  py-6 ">
              “I'll run the course you lay out for me if you'll just show me
              how. God, teach me lessons for living so I can stay the course.
              Give me insight so I can do what you tell me—my whole life one
              long, obedient response.” ( Psalms 119:32-34, MSG ).
            </p>
          </div>
        </section>
        {/* ABOUT CONTENT */}
        <section className=" dark:bg-secondary py-16 xx:px-6 ss:px-12">
          <div className="bg-primary dark:bg-secondary gap-8 items-center ss:py-24 xx:py-12 mx-auto max-w-screen-xl xl:gap-16 grid md:grid-cols-2 sm:py-16 lg:px-6">
            <div className="mt-4 md:mt-0 text-left">
              ...
              <div className="mb-6 font-light text-secondary md:text-lg dark:text-primary">
                <p className="">
                  ...
                  highschool graduation". I wrote stories in that notebook. A
                  few friends read them and I was so proud of those stories.
                  Then the book got missing. It was painful. So painful that I
                  haven't forgotten the feeling. Still in that 2014, I won a
                  national essay writing competition. The way the newspapers put
                  it, they were shocked a public school pupil had come out tops.
                  I still giggle when I read that headline.
                </p>
                <p className="mt-4">
